...
import InterfacesGraficas.Trabajador.Solicitudes.*;
...
public class pnlSolicitudes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (tablaSolicitudes.getColumnModel().getColumnCount() > 0) {
            ...
            tablaSolicitudes.getColumnModel().getColumn(1).setPreferredWidth(250);
            tablaSolicitudes.getColumnModel().getColumn(2).setPreferredWidth(50);
            tablaSolicitudes.getColumnModel().getColumn(3).setPreferredWidth(60);
        }
