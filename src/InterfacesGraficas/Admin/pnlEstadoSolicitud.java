...
public class pnlEstadoSolicitud extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtNuevaDescrip.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)), javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5)));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(40, 40, 40)
                .addComponent(panelSlider, javax.swing.GroupLayout.PREFERRED_SIZE, 447, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnEditarEstadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarEstadoActionPerformed
        ...
        {
            ServicioDeAgua.mensaje.cargarDatos("Editar Estado",
    ...
    private void btnActualizarEstadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarEstadoActionPerformed
        ...
        try {
            if(!nuevoNombre.isEmpty()&&!nuevaDescrip.isEmpty()){ 
                ...
                ServicioDeAgua.mensaje.cargarDatos("Editar Estado"
                        ,"El nombre y/o descripcion del Estado: "+ id
                            +" a sido editado.",1);                
                btnVolver.doClick();                
            }else{
                ServicioDeAgua.mensaje.cargarDatos("Editar Estado",
              ...
              ServicioDeAgua.mensaje.cargarDatos("Editar Estado",
                        "No ha sido posible editar los datos del Estado",1);
        }           
    ...
    public void listarEstados(String buscar){
        try {
            listaEstados = new ArrayList<>();              
            this.servicio.listarEstados(tablaEstados,buscar,listaEstados);
        } catch (SQLException ex) {
            ServicioDeAgua.mensaje.cargarDatos("Error al cargar lista de Estados"
                ,"No es posible mostrar los registros.", 1);
        }
    }
