...
import InterfacesGraficas.Usuario.*;
...
public class Ingreso extends javax.swing.JFrame {
    ...
    public Ingreso() throws ClassNotFoundException, SQLException {
        initComponents();
    ...
    public void abrirForms() throws SQLException {
                
        switch (user.getRol()) {
            case 1:
                PrincipalTrabajador pantallaTrabajador= new PrincipalTrabajador(this.user);
                pantallaTrabajador.setVisible(true);
                break;
            case 2:
                PrincipalUsuario pantallaUsuario = new PrincipalUsuario(this.user);
                pantallaUsuario.setVisible(true);
                break;
            default:
                PrincipalAdmin pantallAdmin = new PrincipalAdmin(this.user);
