 ...
 */
package InterfacesGraficas.Usuario;

import Entidades.*;
import InterfacesGraficas.Login.Ingreso;
...
public class PrincipalUsuario extends javax.swing.JFrame {
    ...
    public PrincipalUsuario(Usuario user ) throws SQLException {
        initComponents(); 
        this.usuario = user;
        this.usuario = padre.getUsuario();      
